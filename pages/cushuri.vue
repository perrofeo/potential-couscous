<template>
  <div>
    ...
    <div class="info text-center">
      <h2>Culantrito le ha dado</h2>
      <p>Los cushuris o cormoranes han llegado desde lejos al tranquilo pueblo de San Martín. Son cientos de aves y seguramente se quedarán poco tiempo. Hay que aprovechar.
        Un grupo de muchachos cruza el lago para intentar cazarlos. ¿Lo lograrán?</p>
    </div>
    <div class="video-cushuri">
      <b-embed
        type="iframe"
        aspect="4by3"
        src="https://www.youtube.com/embed/WJ_qCfC8C-s?rel=0&cc_load_policy=1"
        frameborder="0"
        allow="accelerometer"
        encrypted-media
        gyroscope
    ...
    <div class="credits text-center">
      <p><strong>Protagonistas</strong><br>Dagner Manihuari Mendoza, Reiter Mendoza Ayambo, Exon Jair Lomas Silvano, Elvis Eduardo Lomas Silvano y Jeshuco "El Rey del Mango".</p>
      <p><strong>Canción final</strong><br>Rubén y Avelino</p>
      <p><strong>Dirección, cámara, montaje y producción</strong><br>Igor Rekarte</p>
      <p>Filmado en San Martín del Tipishca (Perú),<br>
        con la ayuda de sus fantásticos habitantes y Casa Lupuna.</p>
    </div>
    <div class="totipishca">
    ...
    return {
      ...
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        {
          ...
          name: 'description',
          content:
            'Los cushuris o cormoranes han llegado desde lejos al tranquilo pueblo de San Martín. Son cientos de aves y seguramente se quedarán poco tiempo. Hay que aprovechar. Un grupo de muchachos cruza el lago para intentar cazarlos. ¿Lo lograrán?'
        },
        {
          hid: 'og:description',
        ...
        },
        {
          hid: 'og:image',
          property: 'og:image',
          content: 'https://www.perrofeofilms.com/Cushuri_portada1.jpg'
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: 'https://www.perrofeofilms.com/cushuri/'
        }
      ]
    }
  }
