<template>
  <div>
    ...
    <div class="info text-center">
      ...
      <div class="info-text">
        <p>
          Reiter cabalga por los ríos amazónicos en busca de un remedio llamado
          <strong>Uña de Gato</strong>.
        </p>
        <p>
          A lomos de su canoa, nos adentraremos en lo más profundo y solitario
          de una selva llena de espejos.
        </p>
      </div>
    </div>
    ...
    <div class="credits text-center">
      <p>
        <strong>Protagonistas</strong><br />Reiter Mendoza Ayambo, Hitler Lomas
        Canaquiri y Exon Jair Lomas Silvano.
      </p>
      <p>
        <strong>Canción final</strong><br /><a
          href="https://youtu.be/6fi2KnQCxDo"
          target="_blank"
          rel="noopener"
          >"Aspiración" por Avelino Lancha Manihuari</a
        >
      </p>
      ...
      <p class="info-text">
        Filmado en 2009 en la Reserva Nacional Pacaya-Samiria (Perú),<br />
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: "og:image",
          property: "og:image",
          content: "https://www.perrofeofilms.com/PortadaCcon_titulo.jpg"
        },
        {
          hid: "og:url",
          property: "og:url",
