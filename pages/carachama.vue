<template>
  <div>
    ...
    <div class="info text-center">
      ...
      <p class="info-text">
        Jair y su pandilla salen en busca del tesoro: los huevos de carachama,
        un pez prehistórico con cara de pocos amigos. Un día lleno de aventuras
        les espera.
      </p>
    </div>
    ...
    <div class="credits text-center">
      <p>
        <strong>Protagonistas</strong><br />Exon Jair Lomas Silvano, Elvis
        Eduardo Lomas Silvano, Álvaro Rengifo Isuiza, Anthony Manihuari Mendoza,
        Moises Manihuari Mendoza, Kener Eliseo Yaicate Pinedo y Jorge Luis
        Yaicate Yuyarima.
      </p>
      <p>
        <strong>Canción final</strong><br />"Sky Skating" por
        <a
          href="https://www.youtube.com/geographermusic"
          target="_blank"
          rel="noopener"
          >Geographer</a
        >
